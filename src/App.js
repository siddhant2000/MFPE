    ...
    <Router>
            ...
            <div className="container mt-3">
                <Routes> 
                      ...
                      <Route exact path = "/getParticipations/Approved" element = {<ListApprovedParticipationComponent/>}></Route>
                      <Route exact path = "/getParticipations/Declined" element = {<ListDeclinedParticipationComponent/>}></Route>
                      <Route exact path = "/getParticipations/Pending" element = {<ListPendingParticipationComponent/>}></Route>
