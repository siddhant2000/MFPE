package com.management.apigateway.config;
...
public class SpringFoxConfig {
    ...
    public ApiInfo getInfo(){
        return new ApiInfo("SPRING CLOUD API GATEWAY SERVICE","This is a microservice of Sport Event Management System to route the requests","1.0" ,"Terms of service"
