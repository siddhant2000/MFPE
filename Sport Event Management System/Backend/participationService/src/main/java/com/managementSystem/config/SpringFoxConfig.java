...
public class SpringFoxConfig {
    ...
    public ApiInfo getInfo(){
        return new ApiInfo("PARTICIPATION SERVICE","This is a microservice of Sport Event Management System,this microservice will call other microservices to fetch the data at the time of adding participation","1.0" ,"Terms of service"
